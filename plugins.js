...
var pluginList = [
    ...
    { name: "mainmenu", url: "10322-plaginy-k-igre", title: "Главное меню", info: "Выпадающий список планет и разделов в мобильной и старой версии на более компактное и удобное меню" },
    { name: "alysab", url: "10322-plaginy-k-igre", title: "САБ с альянсом", info: "Позволяет быстро добавлять членов яльянса в САБ, выбирая их ники из выпадающего списка" },
];
