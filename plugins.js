...
//    { name: "sim", url: "10288-uluchshenie-ui-chitabelnost-poley-v-simulyatore", title: "Улучшение симулятора", info: "Форматирование чисел и расширение полей ввода" },
    ...
    { name: "sensor", url: "10757-plagin-skanirovanie-sistemy", title: "Сканирование системы", info: "Позволяет сканировать все планеты в системе за раз на предмет летящих флотов" },
];
