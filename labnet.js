  ...
  if(panelLabShow) {
    ...
    if(!impLab) {
      ...
      impLab.onload = function(){
        ...
        <tr><td class="c" colspan="3" style="height: 20px;"><div style="display: flex;"><div style="flex-grow: 1;"><a href="' + labSci + 'buildings.php?mode=research&gid=123">Исследовательская сеть</a>: ' + netLevel + '</div><div style="padding: 0 7px; cursor: pointer;" title="Закрыть форму" onclick="switchLabPanel()">X</div></div></td></tr>\
        ...
        text += '<tr><th colspan="3"></th><tr><td class="c" style="height: 16px;"></td><td class="c">Суммарный уровень лаб</td><td class="c">' + totalLevel + '</td></table>';
